...
INSERT INTO tb_facility (toilet_id, facility_type, brand, "model", install_date, warranty_date, status)
SELECT (SELECT id FROM tb_toilet WHERE name = '人民广场公厕'), '无障碍马桶', 'TOTO', 'CW-700A', '2024-01-15', '2027-01-15', 'NORMAL'
WHERE NOT EXISTS (SELECT 1 FROM tb_facility WHERE toilet_id = (SELECT id FROM tb_toilet WHERE name = '人民广场公厕') AND facility_type = '无障碍马桶' AND brand = 'TOTO');
...
INSERT INTO tb_facility (toilet_id, facility_type, brand, "model", install_date, warranty_date, status)
SELECT (SELECT id FROM tb_toilet WHERE name = '火车站公交车站公厕'), '无障碍马桶', 'TOTO', 'CW-850A', '2024-02-10', '2027-02-10', 'NORMAL'
WHERE NOT EXISTS (SELECT 1 FROM tb_facility WHERE toilet_id = (SELECT id FROM tb_toilet WHERE name = '火车站公交车站公厕') AND facility_type = '无障碍马桶' AND brand = 'TOTO');
...
INSERT INTO tb_facility (toilet_id, facility_type, brand, "model", install_date, warranty_date, status)
SELECT (SELECT id FROM tb_toilet WHERE name = '朝阳公园北门公厕'), '照明设备', '欧普', 'OP-LED30', '2024-05-10', '2027-05-10', 'NORMAL'
WHERE NOT EXISTS (SELECT 1 FROM tb_facility WHERE toilet_id = (SELECT id FROM tb_toilet WHERE name = '朝阳公园北门公厕') AND facility_type = '照明设备');
...
INSERT INTO tb_facility (toilet_id, facility_type, brand, "model", install_date, warranty_date, status)
SELECT (SELECT id FROM tb_toilet WHERE name = '滨河大道西段公厕'), '无障碍马桶', 'TOTO', 'CW-900A', '2024-07-20', '2027-07-20', 'NORMAL'
WHERE NOT EXISTS (SELECT 1 FROM tb_facility WHERE toilet_id = (SELECT id FROM tb_toilet WHERE name = '滨河大道西段公厕') AND facility_type = '无障碍马桶' AND brand = 'TOTO');
...
INSERT INTO tb_facility (toilet_id, facility_type, brand, "model", install_date, warranty_date, status)
SELECT (SELECT id FROM tb_toilet WHERE name = '老街步行街中心公厕'), '无障碍马桶', '箭牌', 'JW-200A', '2024-08-10', '2027-08-10', 'NORMAL'
WHERE NOT EXISTS (SELECT 1 FROM tb_facility WHERE toilet_id = (SELECT id FROM tb_toilet WHERE name = '老街步行街中心公厕') AND facility_type = '无障碍马桶' AND brand = '箭牌');
...
INSERT INTO tb_repair_order (order_no, toilet_id, facility_id, fault_desc, reporter_id, assignee_id, status, repair_desc, create_time, finish_time)
SELECT 'RO20260518007', (SELECT id FROM tb_toilet WHERE name = '火车站公交车站公厕'), (SELECT id FROM tb_facility WHERE toilet_id = (SELECT id FROM tb_toilet WHERE name = '火车站公交车站公厕') AND facility_type = '无障碍马桶' AND brand = 'TOTO'), '无障碍马桶冲水按钮卡住', (SELECT id FROM tb_user WHERE username = 'cleaner1'), (SELECT id FROM tb_user WHERE username = 'repair2'), 'FINISHED', '更换冲水按钮弹簧，已恢复正常', SYSDATE - 11, SYSDATE - 10
...
INSERT INTO tb_repair_order (order_no, toilet_id, facility_id, fault_desc, reporter_id, assignee_id, status, create_time)
SELECT 'RO20260522009', (SELECT id FROM tb_toilet WHERE name = '人民广场公厕'), (SELECT id FROM tb_facility WHERE toilet_id = (SELECT id FROM tb_toilet WHERE name = '人民广场公厕') AND facility_type = '无障碍马桶' AND brand = 'TOTO'), '无障碍马桶感应器失灵，长流水', (SELECT id FROM tb_user WHERE username = 'admin'), (SELECT id FROM tb_user WHERE username = 'repair2'), 'REPAIRING', SYSDATE - 6
WHERE NOT EXISTS (SELECT 1 FROM tb_repair_order WHERE order_no = 'RO20260522009');

INSERT INTO tb_repair_order (order_no, toilet_id, facility_id, fault_desc, reporter_id, assignee_id, status, repair_desc, create_time, finish_time)
SELECT 'RO20260523010', (SELECT id FROM tb_toilet WHERE name = '滨河大道西段公厕'), (SELECT id FROM tb_facility WHERE toilet_id = (SELECT id FROM tb_toilet WHERE name = '滨河大道西段公厕') AND facility_type = '无障碍马桶' AND brand = 'TOTO'), '无障碍马桶盖板松动', (SELECT id FROM tb_user WHERE username = 'admin'), (SELECT id FROM tb_user WHERE username = 'repair1'), 'FINISHED', '紧固螺丝，已修复', SYSDATE - 5, SYSDATE - 5
